      ...
      >
        <defs>
          <linearGradient id="strataGrad1" x1="2" y1="6" x2="34" y2="16" gradientUnits="userSpaceOnUse">
            <stop stopColor={isLight ? '#1B5E20' : '#00D084'} />
            <stop offset="1" stopColor={isLight ? '#2E7D32' : '#10B981'} />
          </linearGradient>
          <linearGradient id="strataGrad2" x1="2" y1="14" x2="34" y2="24" gradientUnits="userSpaceOnUse">
            <stop stopColor={isLight ? '#2E7D32' : '#00E676'} />
          ...
          <linearGradient id="strataGrad3" x1="2" y1="22" x2="34" y2="32" gradientUnits="userSpaceOnUse">
            ...
            <stop offset="1" stopColor={isLight ? '#66BB6A' : '#00D084'} />
          </linearGradient>
        </defs>
        ...
        <circle cx="18" cy="10.5" r="1.8" fill={isLight ? "#FFFFFF" : "#060B12"} stroke={isLight ? "#1B5E20" : "#00D084"} strokeWidth="1" />
      </svg>
    </div>
  )
}
