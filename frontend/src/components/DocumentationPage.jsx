    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-12 py-10 grid grid-cols-1 lg:grid-cols-12 gap-10">
              ...
              return (
                <button
                  ...
                  className={`w-full p-3 rounded-xl text-left text-xs font-mono font-bold flex items-center gap-3 transition-all cursor-pointer ${
                    isCurrent
                      ? isLight
                        ? 'bg-[#E8F5E9] text-[#1B5E20] border border-[#1B5E20]/30 shadow-sm'
        ...
        <main className="lg:col-span-9 space-y-16 text-sm">
          ...
          <section id="overview" className="space-y-4 scroll-mt-28">
            <div className={`p-6 rounded-2xl border ${isLight ? 'bg-white border-[#C8E6C9]' : 'bg-[#0B131E] border-[#1E293B]'}`}>
              ...
              <div className={`p-4 rounded-xl border mt-4 ${
                ...
                <div className={`text-xs font-mono font-bold mb-1 uppercase ${isLight ? 'text-[#1B5E20]' : 'text-[#00D084]'}`}>
                  Formal Acronym Definition:
                </div>
                <div className={`text-lg sm:text-xl font-black font-mono ${isLight ? 'text-[#1B5E20]' : 'text-white'}`}>
                  <span className="text-[#00D084]">S</span>patial{' '}
                  <span className="text-[#00D084]">T</span>opology,{' '}
                  <span className="text-[#00D084]">R</span>egistration and{' '}
                  <span className="text-[#00D084]">A</span>dministration of{' '}
                  <span className="text-[#00D084]">T</span>hree-dimensional{' '}
                  <span className="text-[#00D084]">A</span>ssets
                </div>
              </div>
          ...
          <section id="standards" className="space-y-4 scroll-mt-28">
            <div className={`p-6 rounded-2xl border ${isLight ? 'bg-white border-[#C8E6C9]' : 'bg-[#0B131E] border-[#1E293B]'}`}>
              ...
              <div className="space-y-4 mt-4">
                <div className={`p-4 rounded-xl border ${isLight ? 'bg-slate-50 border-slate-200' : 'bg-[#0F172A] border-[#1E293B]'}`}>
                  <h3 className={`font-bold text-sm mb-2 ${isLight ? 'text-[#1B5E20]' : 'text-[#00D084]'}`}>
                  ...
                  <ul className="mt-2 space-y-1 text-xs text-slate-500">
                    <li>• <code className="px-1.5 py-0.5 rounded bg-black/30 font-mono text-[#00D084]">LA_SpatialUnit</code>: Base parcel and multi-dimensional spatial representation.</li>
                    <li>• <code className="px-1.5 py-0.5 rounded bg-black/30 font-mono text-[#00D084]">LA_LegalSpaceBuildingUnit</code>: Individual 3D residential apartment, commercial unit, or basement asset.</li>
                    <li>• <code className="px-1.5 py-0.5 rounded bg-black/30 font-mono text-[#00D084]">LA_RRR</code>: Volumetric Rights, Restrictions, and Responsibilities.</li>
                  </ul>
                </div>
          ...
          <section id="ulpin" className="space-y-4 scroll-mt-28">
            <div className={`p-6 rounded-2xl border ${isLight ? 'bg-white border-[#C8E6C9]' : 'bg-[#0B131E] border-[#1E293B]'}`}>
              ...
              {/* Syntax Card */}
              <div className="p-4 rounded-xl bg-black/40 border border-[#1E293B] font-mono text-xs space-y-2 mt-4">
                <div className="text-slate-400">Canonical 3D-ULPIN Format:</div>
                <div className="p-3 rounded-lg bg-black/60 text-[#00D084] font-bold text-sm tracking-wider flex items-center justify-between">
                  ...
                  >
                    {copiedCode === 'syntax' ? <Check className="w-4 h-4 text-[#00D084]" /> : <Copy className="w-4 h-4" />}
                  </button>
                </div>
              </div>

              {/* Interactive Simulator */}
              <div className={`p-5 rounded-xl border mt-4 ${isLight ? 'bg-slate-50 border-slate-200' : 'bg-[#0F172A] border-[#1E293B]'}`}>
                <h3 className={`font-bold text-xs uppercase tracking-wider mb-4 ${isLight ? 'text-[#1B5E20]' : 'text-[#00D084]'}`}>
                ...
                <div className="mt-4 p-4 rounded-xl bg-[#00D084]/10 border border-[#00D084]/40 flex flex-col sm:flex-row items-center justify-between gap-3">
                  <div>
                    <div className="text-[11px] font-mono text-slate-400">Generated 3D Bhu-Aadhaar Identifier:</div>
                    <div className="text-base font-black font-mono text-[#00D084]">{generated3DULPIN}</div>
                  </div>
                  <button
                    onClick={() => handleCopy(generated3DULPIN, 'gen')}
                    className="px-3 py-1.5 rounded-lg bg-[#00D084] text-[#060B12] text-xs font-mono font-bold flex items-center gap-1.5 hover:bg-[#00b875] transition-all"
                  >
          ...
          <section id="topology" className="space-y-4 scroll-mt-28">
            <div className={`p-6 rounded-2xl border ${isLight ? 'bg-white border-[#C8E6C9]' : 'bg-[#0B131E] border-[#1E293B]'}`}>
              ...
              <div className="p-4 rounded-xl bg-black/40 border border-[#1E293B] font-mono text-xs space-y-3 mt-4">
                <div className="text-[#00D084] font-bold">Euler's Formula for 2-Manifold Closed Polyhedra:</div>
          ...
          <section id="mutation" className="space-y-4 scroll-mt-28">
            <div className={`p-6 rounded-2xl border ${isLight ? 'bg-white border-[#C8E6C9]' : 'bg-[#0B131E] border-[#1E293B]'}`}>
              ...
              <div className="space-y-3 mt-4 text-xs text-slate-500">
                ...
                <div className="p-4 rounded-xl bg-black/40 border border-[#1E293B] font-mono space-y-1">
                  <div className="text-slate-400">// Parent Unit:</div>
                  <div className="text-[#00D084]">Parent: IND280145987621-A+04-7F9C (226.8 m³)</div>
      ...
      >
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="text-[#00D084] hover:underline flex items-center gap-1"
        >
